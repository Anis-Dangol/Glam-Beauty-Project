    ...
    <section className="flex flex-col gap-20">
      <div className="flex items-center gap-4 px-27">
        <div className="flex-1 space-y-4">
          <h2 className="font-bold text-[40px] text-[#5B4636]">About Us</h2>
      ...
      <div className="flex items-center gap-4 px-27">
        ...
        <div className="flex-1 space-y-4">
          <h2 className="font-bold text-[40px] text-[#5B4636]">Our Mission</h2>
          <p className="font-normal text-[20px] leading-[1.7] text-[#5B4636]">
            We are on a mission to help everyone celebrate their individuality
            by redefining what beautiful means.
            <br></br>
            We want to promote self-acceptance and give people the tools they
